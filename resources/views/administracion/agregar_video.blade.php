...
<br><br><h1 style="margin-top:20px; text-align:center">Agregar Video</h1><br>
<form method="POST" action="video_administracion" enctype="multipart/form-data">
	...
	{{ csrf_field() }}
	<input type="text" name="TITULO" placeholder="Titulo" class="form-control fs-4" style="width:85%; margin:10px 7.5%;  border: none; border-bottom: 1px solid #fff; outline: none; background: #eee;color:#000" required="True">
